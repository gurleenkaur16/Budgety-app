...
var budgetController = (function() {
    ...
    var data = {
        ...
        budget: 0,
        percentage: -1 //something not existing is set to -1
    };
...
var UIController = (function() {
    ...
    return {
        ...
        getDOMstrings: function() { //expose DOMstrings to public
            return DOMstrings;
        }
    };
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlAddItem = function() {
        ...
        input = UICtrl.getInput(); //calling the getinput method fron UIctrl
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if (itemID) {
            ...
            //delete the item fron datastructure
